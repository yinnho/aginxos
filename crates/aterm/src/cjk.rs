// cjk — wide-glyph (Chinese/emoji) rendering for aterm (M38a).
//
...
// adb-pushed aterm without the rootfs — the terminal degrades to today's
...
/// Override for the host/adb dev loop (`aterm --ppm`, pre-rebake pushes):
